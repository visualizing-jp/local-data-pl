...
import { AOMORI_BOOKLET_PAGES, HOKKAIDO_BOOKLET_YEAR, IWATE_BOOKLET_PAGES, KANAGAWA_BOOKLET_PAGES, OKINAWA_BOOKLET_PAGES, SAPPORO_CODE, SAPPORO_MIC_EXCEL, TOKYO_BOOKLET_YEARS } from "./sources.ts";
